...
public class GetReturnFileCountOps {
		public Response getReturnFileCountResponse(String authToken, HashMap<String, String> paramMap, String pathParam, Heart heart) {
