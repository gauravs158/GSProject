...
public class GetReturnFileDetailsOps {
		public Response getReturnFileDetailsResponse(String authToken, HashMap<String, String> paramMap, String pathParam, Heart heart) {
