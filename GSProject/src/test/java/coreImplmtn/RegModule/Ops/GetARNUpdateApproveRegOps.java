...
public class GetARNUpdateApproveRegOps {
	public Response getARNUpdateApproveResponse(String authToken, HashMap<String, String> paramMap, String pathParam, Heart heart) {
