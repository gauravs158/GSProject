...
//		this.log = LogManager.getLogger(GetAllAlertComSD.class);
	}
...
//		Log4jLoggerFile.info("Hitting the GetAllAlertCom API");
...
//		Log4jLoggerFile.info("GetAllAlertCom API response received.");
...
//		Log4jLoggerFile.info("Completed the_user_hits_GetAllAlertComSD_api method");
	}
