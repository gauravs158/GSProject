...
//        Setup.extentTest.get().info(MarkupHelper.createLabel(log, ExtentColor.TEAL));
        Setup.extentTest.get().info(MarkupHelper.createLabel(log, ExtentColor.INDIGO));
    }
    public static void logWarningDetails(String log) {
        Setup.extentTest.get().warning(MarkupHelper.createLabel(log, ExtentColor.YELLOW));
    }
    public static void logJson(String object) {
        Setup.extentTest.get().info(MarkupHelper.createCodeBlock(object, CodeLanguage.JSON));
    }
